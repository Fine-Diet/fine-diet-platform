...
interface HeroMediumSectionProps {
...
export const HeroMediumSection = ({ homeContent }: HeroMediumSectionProps) => {
  ...
  return (
    <section className="relative isolate overflow-hidden rounded-b-[2.5rem]">
      ...
      <div className="relative mx-auto flex h-[66vh] max-w-[1200px] flex-col items-center justify-center gap-2 px-6 py-0 text-center sm:px-10 lg:py-0">
