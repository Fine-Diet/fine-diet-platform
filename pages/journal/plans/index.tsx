...
function buildUpNextSummary({
  ...
  if (!hasProfileSchedule) {
    return {
      ...
      label: 'Meal rhythm',
      status: 'SETUP',
      detail: 'Set your meal rhythm so Plans knows which occasions to fill.',
      meta: 'Same setup used across Plans, Today, Week, and Home.',
      ctaLabel: 'Set meal rhythm',
      ctaHref: APP_ROUTES.plansRhythm,
      needsSupport: [],
    };
  }
  ...
  if (slots.length === 0) {
    return {
      ...
      label: 'Meal rhythm',
      status: 'SETUP',
      detail: 'No meal occasions are enabled right now.',
      meta: 'Enable occasions in Meal Rhythm before planning.',
      ctaLabel: 'Review meal rhythm',
      ctaHref: APP_ROUTE_BUILDERS.profileMealRhythm(),
      needsSupport: [],
    };
  }
