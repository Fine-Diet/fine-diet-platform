...
export const MODULE_FIELD_DESCRIPTORS: ModuleFieldDescriptorMap = {
  ...
  'lead.waitlist-capture.v1': [
    ...
    {
      key: 'firstNameLabel',
      label: 'First name label (banded)',
      type: 'text',
      optional: true,
      group: 'Banded layout',
      placeholder: 'First Name',
      hint: 'Used only in the banded layout, where Name is split into First / Last line inputs. The backend still receives one combined `name`.',
    },
    {
      key: 'lastNameLabel',
      label: 'Last name label (banded)',
      type: 'text',
      optional: true,
      group: 'Banded layout',
    ...
    },
    {
      ...
      optional: true,
      group: 'Banded layout',
      options: ['standard', 'banded'],
      hint: 'banded = full-width pale band with a top rail and centered content (prototype style). standard (default) = legacy single-column style.',
    },
    {
      key: 'backgroundTone',
      ...
      optional: true,
      group: 'Banded layout',
      options: ['cream', 'blue', 'default'],
      hint: 'blue = pale denim band (prototype). cream / default = legacy brand-50 cream.',
    },
    {
      key: 'railEnabled',
      label: 'Show top rail',
      ...
      optional: true,
      group: 'Banded layout',
      hint: 'Repeating label rail at the top of the band. Defaults to on in the banded layout.',
    },
    {
      key: 'railText',
      label: 'Rail text',
      ...
      hint: 'Defaults to "JOIN THE WAITLIST" when blank in the banded layout.',
    },
    {
      key: 'anchorId',
      label: 'Anchor id',
      ...
      hint: 'Rendered as <section id="..."> so page CTAs / nav can scroll to this band (e.g. #waitlist). Sanitized to a safe slug.',
    },
  ],
  ...
  'access.code-gate.v1': [
    ...
    },
    {
      ...
      hint: 'Defaults to "ENTER ACCESS CODE" when blank in the banded layout.',
    },
    {
      key: 'anchorId',
      label: 'Anchor id',
      ...
      hint: 'Rendered as <section id="..."> so page CTAs / nav can scroll to this band (e.g. #access-code). Sanitized to a safe slug.',
    },
  ],
